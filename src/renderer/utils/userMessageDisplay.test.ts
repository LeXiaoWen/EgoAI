...
const WIN_INBOUND = String.raw`C:\Users\zhangsan\AppData\Roaming\EgoAI\openclaw\state\media\inbound`;
const MAC_INBOUND = '/Users/zhangsan/Library/Application Support/EgoAI/openclaw/state/media/inbound';
...
describe('EgoAI goal mode command display', () => {
