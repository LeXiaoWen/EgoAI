  ...
  test('links a chained Bash cd command to Browser navigation and the assistant response', () => {
    const messages = [
      ...
      makeMessage('bash-1', 'tool_use', '', {
        ...
        toolUseId: 'tool-1',
        toolInput: {
          command: 'lsof -ti:8765 | xargs kill -9 2>/dev/null; sleep 1; cd /Users/admin/egoai/project/dayan-shenjun && npm run dev',
        },
      }),
