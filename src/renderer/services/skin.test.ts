...
describe('normalizeActiveSkin', () => {
      ...
      skin: {
        ...
        assets: {
          [SkinAssetSlot.WorkspaceBackdrop]: {
            url: 'ego-skin://asset/sunset-glass/workspace.backdrop',
            hash: 'backdrop-hash',
          },
          [SkinAssetSlot.HomeEmblem]: 'ego-skin://asset/sunset-glass/home.emblem',
          'sidebar.icon': 'ego-skin://asset/sunset-glass/sidebar.icon',
        },
      },
    });
    ...
    expect(skin).toEqual({
      ...
      assets: {
        ...
        [SkinAssetSlot.HomeEmblem]: {
          url: 'ego-skin://asset/sunset-glass/home.emblem',
        },
      },
    });
  });
  ...
  test('accepts manifest metadata with separately resolved asset URLs', () => {
    const skin = normalizeActiveSkin({
      ...
      assetUrls: {
        [SkinAssetSlot.WorkspaceBackdrop]: 'ego-skin://asset/paper-cut/workspace.backdrop',
        [SkinAssetSlot.HomeEmblem]: 'ego-skin://asset/paper-cut/home.emblem',
      },
    });
  ...
  test('returns null when no supported image asset is available', () => {
    expect(normalizeActiveSkin({
      id: 'unsafe',
      assets: { 'sidebar.icon': 'ego-skin://asset/unsafe/sidebar.icon' },
    })).toBeNull();
    expect(normalizeActiveSkin({
      id: 'remote',
      assets: {
      ...
      skins: [
        {
          ...
          name: '三国蜀汉 Q 版',
          assets: {
            [SkinAssetSlot.WorkspaceBackdrop]: 'ego-skin://asset/three-kingdoms/workspace.backdrop',
            [SkinAssetSlot.HomeEmblem]: 'ego-skin://asset/three-kingdoms/home.emblem',
          },
        },
        {
          id: 'remote-only',
...
describe('buildSkinAssetUrl', () => {
  test('keeps managed skin protocol URLs because they already contain a content hash', () => {
    expect(buildSkinAssetUrl({
      url: 'ego-skin://asset/demo/workspace.backdrop?v=backdrop-hash',
      cacheKey: 'sha 256',
    }, 3)).toBe('ego-skin://asset/demo/workspace.backdrop?v=backdrop-hash');
  });
