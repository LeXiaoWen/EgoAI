...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    engineStartingTip4: '接入微信、企业微信、QQ 等聊天工具，在 IM 里随时召唤 AI',
    ...
    coworkErrorModelSourceEgoAIPlan: 'EgoAI 服务模型',
    ...
    // 知识库连接（纯客户端方向）
    kbConnectionTitle: '知识库连接',
    kbConnectionTitleHint: '连接你自己的 WeKnora 实例，让对话 Agent 能检索知识库并带引用回答。',
    kbConnectionBaseUrlLabel: '实例地址',
    kbConnectionBaseUrlHint: 'WeKnora Web UI 地址（不含 /api/v1），如 http://127.0.0.1:8080',
    kbConnectionApiKeyLabel: 'API Key',
    kbConnectionApiKeyHint: '在 WeKnora 租户设置里创建的 API Key',
    kbConnectionExternalUiHint:
      '知识库的创建 / 上传 / 解析管理在 WeKnora 网页端完成；这里仅保存连接供 EgoAI 对话检索。',
    kbConnectionTestAuthError: '连接失败：API Key 无效或无权限',
    kbConnectionTestUnreachable: '无法连接：请检查实例地址是否可达',
    kbListButton: '查看可用知识库',
    kbListLoading: '获取知识库中...',
    kbListEmpty: '当前连接下没有可用知识库',
    kbListRefresh: '刷新',
    kbListLoadFailed: '获取失败：请求无效或服务异常',
    kbListLoadAuthError: '获取失败：API Key 无效或无权限',
    kbListLoadUnreachable: '无法连接：请检查实例地址是否可达',
    kbScopeLabel: '知识库范围',
    kbScopeModeAll: '全部知识库',
    kbScopeModeSpecific: '指定知识库',
    kbScopeModeNone: '不检索',
    kbScopeNoConnection: '未配置知识库连接，请先在设置中连接 WeKnora',
  },
  en: {
    // Common
    save: 'Save',
    ...
    engineStartingTip4:
      'Connect WeChat, WeCom, QQ and more to summon AI right from your IM apps',
    engineStartingTip5:
    ...
    coworkErrorModelSourceEgoAIPlan: 'EgoAI service model',
    ...
    // Knowledge base connection (pure client direction)
    kbConnectionTitle: 'Knowledge Base Connection',
    kbConnectionTitleHint: 'Connect your own WeKnora instance so chat agents can search the knowledge base and answer with citations.',
    kbConnectionBaseUrlLabel: 'Instance URL',
    kbConnectionBaseUrlHint: 'Your WeKnora Web UI URL without /api/v1, e.g. http://127.0.0.1:8080',
    kbConnectionApiKeyLabel: 'API Key',
    kbConnectionApiKeyHint: 'An API key created in your WeKnora tenant settings',
    kbConnectionExternalUiHint:
      'Creating / uploading / parsing knowledge bases happens in the WeKnora web UI; this connection is only used by EgoAI for retrieval in chat.',
    kbConnectionTestAuthError: 'Connection failed: invalid API key or insufficient permission',
    kbConnectionTestUnreachable: 'Unreachable: check that the instance URL is reachable',
    kbListButton: 'View available knowledge bases',
    kbListLoading: 'Fetching knowledge bases...',
    kbListEmpty: 'No knowledge bases available for this connection',
    kbListRefresh: 'Refresh',
    kbListLoadFailed: 'Failed to load: invalid request or server error',
    kbListLoadAuthError: 'Failed to load: invalid API key or insufficient permission',
    kbListLoadUnreachable: 'Unreachable: check that the instance URL is reachable',
    kbScopeLabel: 'Knowledge base scope',
    kbScopeModeAll: 'All knowledge bases',
    kbScopeModeSpecific: 'Specific knowledge base',
    kbScopeModeNone: 'No retrieval',
    kbScopeNoConnection: 'No knowledge base connection configured. Connect WeKnora in Settings first.',
  },
};
