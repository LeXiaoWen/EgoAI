...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    authQuotaExhausted:
      '今日免费额度已用完。您可以登录 EgoAI Portal 购买套餐或积分包继续使用，或在设置中配置自己的 API Key。',
    authTopUpLink: '充值',
    authSettingsLink: '设置',
    ...
    enterpriseQuotaMemberMemberDesc: '向团队管理员申请提高成员额度后继续使用 EgoAI。',
    enterpriseQuotaMemberAdminDesc: '调整额度后继续使用 EgoAI。',
    ...
    enterpriseQuotaPoolMemberDesc: '通知团队管理员购买团队积分包后继续使用 EgoAI。',
    enterpriseQuotaPoolAdminDesc: '购买团队积分包后，团队成员可继续使用 EgoAI。',
    ...
    coworkErrorLobsterAILoginExpired: '登录状态已过期，请重新登录后继续使用 EgoAI 套餐模型。',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'EgoAI 套餐',
  ...
  en: {
    ...
    authQuotaExhausted:
      'Daily free quota exhausted. Visit EgoAI Portal to purchase a plan or credits, or configure your own API Key in Settings.',
    ...
    enterpriseQuotaMemberMemberDesc: 'Request a higher member quota from your team administrator to continue using EgoAI.',
    enterpriseQuotaMemberAdminDesc: 'Adjust your quota to continue using EgoAI.',
    ...
    enterpriseQuotaPoolMemberDesc: 'Notify your team administrator to purchase a Team credit pack and continue using EgoAI.',
    enterpriseQuotaPoolAdminDesc: 'Purchase a Team credit pack so members can continue using EgoAI.',
    ...
    siteQuotaChooseHint: 'Choose an online site. EgoAI will never stop one automatically.',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'EgoAI plan',
