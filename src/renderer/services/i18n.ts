...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    aiSkinCreationGuide: '可前往“专家套件”使用「EgoAI 外观定制」，或直接开始创作。',
    ...
    aiSkinDeleteManagedCopyNote: '只会删除 EgoAI 管理的皮肤副本，不会删除会话中的原始生成图片或卸载 AI 皮肤设计师套件。',
    aiSkinDeleteFailed: '删除皮肤失败，请重试',
    uiFontSize: 'UI 字号',
    uiFontSizeDescription: '调整 EgoAI 界面使用的基准字号',
    codeFontSize: '代码字体大小',
    ...
    shortcutDescNewChat: '开始一个新的 EgoAI 任务',
    shortcutDescFocusPrompt: '跳回 EgoAI 并聚焦当前输入框',
    ...
    shortcutDescOpenCowork: '切换到 EgoAI 任务视图',
    ...
    artifactPreviewCardLobsterBrowser: 'EgoAI',
    artifactPreviewCardOpenInLobsterBrowser: '在 EgoAI 中打开',
    ...
    coworkWorkingDirectoryHint: 'EgoAI 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 EgoAI 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 EgoAI 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'EgoAI 使用模型设置中的当前模型与提供商配置。',
    coworkModelSettingsAction: '前往模型设置',
    modelSelectorMoreModels: '更多模型',
    modelSelectorLoginTitle: '模型不可用',
    modelSelectorLoginDesc: '请在设置中配置模型与 API Key，或选择其他可用模型',
    modelSelectorLoginBtn: '知道了',
    ...
    openClawDataBackupBlockingTitle: '正在备份 EgoAI 数据',
    ...
    openClawDataMigrationBlockingTitle: '正在准备导入 EgoAI 数据',
    ...
    openClawDataMigrationConfirmTitle: '导入 EgoAI 数据备份？',
    ...
    coworkConfigSaveFailed: '保存 EgoAI 配置失败，请稍后重试。',
    ...
    coworkPermissionDescription: 'EgoAI 请求执行以下操作',
    coworkSelectionRequired: '请选择',
    coworkSelectionDescription: 'EgoAI 需要你做出选择',
    coworkToolName: '工具名称',
    ...
    coworkHomeTagline: '我是 EgoAI，你的全场景办公 Agent',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'EgoAI 服务模型',
    ...
    dshSettingsDesc: '内置 DeepSeek 官方开源 agent 框架（dsh）。启用后，EgoAI 的模型供应商配置会自动同步给 dsh。',
    ...
    pluginsConfigShowSecret: '显示',
    pluginsConfigHideSecret: '隐藏',
    ...
    browserWebAccessDescription: '使用 EgoAI 独立浏览器，管理网页打开方式和访问规则。',
    ...
    browserProfileManagedDescription: 'EgoAI 启动一个专用浏览器，稳定、干净。',
    ...
    browserFollowGlobalProxyDescription:
      '默认开启。关闭后仅作为 EgoAI 配置保留，当前版本仍受浏览器自身代理设置影响。',
    ...
    browserBlockedHostnamesDescription: 'EgoAI 不会打开这些网站',
    browserHostnameListEmpty: '尚未添加域名',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: '添加已屏蔽域名',
    browserAddBlockedHostnameDescription: '这意味着 EgoAI 不会打开此 URL',
    browserAddAllowedHostnameTitle: '添加允许域名',
    browserAddAllowedHostnameDescription: '这意味着 EgoAI 可以打开此域名',
    ...
    notificationSystemPermissionHint: '若未收到通知，请在系统设置中允许 EgoAI 发送通知。',
    ...
    usageAnalyticsEnabled: '帮助改进 EgoAI',
    ...
    knowledgeBaseListDescription: '集中管理你的本地知识库：上传 txt / md 文档，入库后可对其检索。',
    knowledgeBaseCreateButton: '新建',
    knowledgeBaseCreateTitle: '新建知识库',
    knowledgeBaseNameLabel: '名称',
    knowledgeBaseDescriptionLabel: '描述（可选）',
    knowledgeBaseCreateConfirm: '创建',
    knowledgeBaseDeleteTitle: '删除知识库',
    knowledgeBaseDeleteConfirm: '确定要删除知识库「{name}」吗？其中所有文档将一并移除，此操作不可撤销。',
    knowledgeBaseListEmpty: '暂无知识库，点击上方「新建」创建一个',
    knowledgeBaseNoDescription: '暂无描述',
    knowledgeBaseDocCount: '文档 {count}',
    knowledgeBaseUploadButton: '上传文档',
    knowledgeBaseUploading: '上传中…',
    knowledgeBaseUploadHint: '仅支持 .txt / .md / .markdown / .text 纯文本',
    knowledgeBaseDocListEmpty: '还没有文档，点击「上传文档」加入第一个',
    knowledgeBaseDocsTab: '文档',
    knowledgeBaseSearchTab: '检索',
    knowledgeBaseDocDeleteTitle: '删除文档',
    knowledgeBaseDocDeleteConfirm: '确定要删除「{name}」吗？此操作不可撤销。',
    knowledgeBaseParseStatus_pending: '排队中',
    knowledgeBaseParseStatus_processing: '解析中',
    knowledgeBaseParseStatus_finalizing: '整理中',
    knowledgeBaseParseStatus_completed: '已完成',
    knowledgeBaseParseStatus_failed: '失败',
    knowledgeBaseParseStatus_deleting: '删除中',
    knowledgeBaseParseStatus_cancelled: '已取消',
    knowledgeBasePageInfo: '第 {page} / {totalPages} 页 · 共 {total} 条',
    knowledgeBasePagePrev: '上一页',
    knowledgeBasePageNext: '下一页',
    knowledgeBaseSearchPlaceholder: '输入关键词检索…',
    knowledgeBaseSearchButton: '检索',
    knowledgeBaseSearchIdle: '输入关键词，检索该知识库的文档内容',
    knowledgeBaseSearchEmpty: '无检索结果，换个关键词试试',
    knowledgeBaseScoreLabel: '相关度',
  },
  en: {
    // Common
    save: 'Save',
    ...
    aiSkinCreationGuide: 'Use “Customize EgoAI” in Expert Kits, or start here.',
    ...
    aiSkinDeleteManagedCopyNote: 'Only EgoAI-managed skin copies are removed. Original images in the conversation and the AI Skin Designer kit are kept.',
    aiSkinDeleteFailed: 'Failed to delete the skin. Please try again.',
    uiFontSize: 'UI font size',
    uiFontSizeDescription: 'Adjust the base size used for the EgoAI UI',
    ...
    copied: 'Copied',
    copyrightHolder: 'EgoAI. All rights reserved.',
    ...
    shortcutScopeHint:
      'Shortcuts only run while the EgoAI window is focused; while a text field is focused, only shortcuts with a Cmd/Ctrl modifier trigger.',
    ...
    shortcutDescNewChat: 'Start a new EgoAI task',
    shortcutDescFocusPrompt: 'Return to EgoAI and focus the current prompt',
    ...
    shortcutDescOpenCowork: 'Switch to the EgoAI task view',
    ...
    artifactPreviewCardLobsterBrowser: 'EgoAI',
    artifactPreviewCardOpenInLobsterBrowser: 'Open in EgoAI',
    ...
    coworkWorkingDirectoryHint: 'EgoAI will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for EgoAI...',
    coworkSystemPromptHint: "Optional system prompt to customize EgoAI's behavior",
    ...
    coworkModelSettingsHint:
      'EgoAI uses the current model and provider configuration from Model Settings.',
    coworkModelSettingsAction: 'Go to Model Settings',
    modelSelectorMoreModels: 'More models',
    modelSelectorLoginTitle: 'Model unavailable',
    modelSelectorLoginDesc: 'Configure a model and API Key in Settings, or choose another available model',
    modelSelectorLoginBtn: 'Got it',
    ...
    openClawDataBackupBlockingTitle: 'Backing up EgoAI data',
    ...
    openClawDataMigrationBlockingTitle: 'Preparing to import EgoAI data',
    openClawDataMigrationBlockingDesc:
    ...
    openClawDataMigrationConfirmTitle: 'Import EgoAI data backup?',
    openClawDataMigrationConfirmDesc:
    ...
    coworkConfigSaveFailed: 'Failed to save EgoAI settings. Please try again.',
    ...
    coworkPermissionDescription: 'EgoAI is requesting to perform the following action',
    coworkSelectionRequired: 'Please Choose',
    coworkSelectionDescription: 'EgoAI needs your input',
    ...
    coworkHomeTagline: "I'm EgoAI, your all-in-one office agent",
    ...
    coworkErrorModelAccessDenied:
      'Your current credentials are not allowed to access the selected model. Switch models or check the model provider configuration.',
    ...
    coworkGatewaySessionSyncTimeout:
      'The OpenClaw engine is responding slowly and your message has not been sent. Please wait a minute or two and resend. If this happens frequently, check system memory and disk usage, and add EgoAI to your antivirus allowlist.',
    ...
    coworkErrorModelSourceLobsterAIPlan: 'EgoAI service model',
    ...
    // Security scan
    egoGuardEnabled: 'Security Active',
    ...
    dshSettingsTitle: 'DeepSeek Harness',
    dshSettingsDesc: 'Bundles DeepSeek\'s official open-source agent framework (dsh). Once enabled, EgoAI\'s model provider configuration syncs into dsh automatically.',
    ...
    pluginsConfigShowSecret: 'Show',
    pluginsConfigHideSecret: 'Hide',
    pluginsSourceOpenclaw: 'OpenClaw',
    ...
    browserWebAccessDescription: 'Use the EgoAI separate browser and manage page access rules.',
    ...
    browserProfileManagedDescription:
      'EgoAI starts a dedicated browser that is stable and clean.',
    ...
    browserFollowGlobalProxyDescription:
      'Enabled by default. Turning it off is stored for EgoAI, but this version can still be affected by the browser proxy settings.',
    ...
    browserBlockedHostnamesDescription: 'EgoAI will not open these websites',
    browserHostnameListEmpty: 'No domains added yet',
    browserHostnameInputPlaceholder: 'example.com',
    browserAddBlockedHostnameTitle: 'Add blocked domain',
    browserAddBlockedHostnameDescription: 'This means EgoAI will not open this URL',
    browserAddAllowedHostnameTitle: 'Add allowed domain',
    browserAddAllowedHostnameDescription: 'This means EgoAI can open this domain',
    ...
    notificationSystemPermissionHint:
      'If you are not receiving notifications, allow EgoAI to send notifications in the system settings.',
    ...
    usageAnalyticsEnabled: 'Help improve EgoAI',
    usageAnalyticsEnabledDescription:
    ...
    welcomeAgreementLinkText: 'EgoAI Terms of Service',
    welcomeCopyright: '© {year} EgoAI',
    ...
    knowledgeBaseListDescription: 'Manage your local knowledge bases: upload txt / md documents, then search across them.',
    knowledgeBaseCreateButton: 'New',
    knowledgeBaseCreateTitle: 'Create Knowledge Base',
    knowledgeBaseNameLabel: 'Name',
    knowledgeBaseDescriptionLabel: 'Description (optional)',
    knowledgeBaseCreateConfirm: 'Create',
    knowledgeBaseDeleteTitle: 'Delete Knowledge Base',
    knowledgeBaseDeleteConfirm: 'Delete the knowledge base "{name}"? All documents inside will be removed. This cannot be undone.',
    knowledgeBaseListEmpty: 'No knowledge bases yet. Click "New" above to create one.',
    knowledgeBaseNoDescription: 'No description',
    knowledgeBaseDocCount: '{count} docs',
    knowledgeBaseUploadButton: 'Upload',
    knowledgeBaseUploading: 'Uploading…',
    knowledgeBaseUploadHint: 'Plain text only: .txt / .md / .markdown / .text',
    knowledgeBaseDocListEmpty: 'No documents yet. Click "Upload" to add the first one.',
    knowledgeBaseDocsTab: 'Documents',
    knowledgeBaseSearchTab: 'Search',
    knowledgeBaseDocDeleteTitle: 'Delete Document',
    knowledgeBaseDocDeleteConfirm: 'Delete "{name}"? This cannot be undone.',
    knowledgeBaseParseStatus_pending: 'Pending',
    knowledgeBaseParseStatus_processing: 'Processing',
    knowledgeBaseParseStatus_finalizing: 'Finalizing',
    knowledgeBaseParseStatus_completed: 'Completed',
    knowledgeBaseParseStatus_failed: 'Failed',
    knowledgeBaseParseStatus_deleting: 'Deleting',
    knowledgeBaseParseStatus_cancelled: 'Cancelled',
    knowledgeBasePageInfo: 'Page {page} / {totalPages} · {total} total',
    knowledgeBasePagePrev: 'Prev',
    knowledgeBasePageNext: 'Next',
    knowledgeBaseSearchPlaceholder: 'Search by keyword…',
    knowledgeBaseSearchButton: 'Search',
    knowledgeBaseSearchIdle: 'Enter a keyword to search documents in this knowledge base',
    knowledgeBaseSearchEmpty: 'No results. Try a different keyword.',
    knowledgeBaseScoreLabel: 'Score',
  },
};

// localStorage key read by index.html's pre-React splash to localize its title
const LANGUAGE_HINT_STORAGE_KEY = 'ego-language';
