import { supportsEgoAIRequestOptionsV1 } from '@shared/providers/egoAIRequestOptions';
import {
 ...
 */
const STORAGE_KEY = 'egoai.model-thinking-levels';
...
export function resolveThinkingLevelForModel(
  ...
  if (!config || !supportsEgoAIRequestOptionsV1(model.requestCapabilities)) return '';
