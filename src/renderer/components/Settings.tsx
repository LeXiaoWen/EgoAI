import { ArchiveBoxIcon, ArrowPathIcon, ArrowPathRoundedSquareIcon, ChatBubbleLeftIcon, CheckCircleIcon, CpuChipIcon, CubeIcon, ExclamationTriangleIcon, GlobeAltIcon, InformationCircleIcon, MagnifyingGlassIcon, SignalIcon, SunIcon, TrashIcon, WrenchScrewdriverIcon, XMarkIcon } from '@heroicons/react/24/outline';
...
type TabType = 'general' | 'appearance' | 'coworkAgentEngine' | 'model' | 'browserWebAccess' | 'coworkMemory' | 'coworkDreaming' | 'shortcuts' | 'im' | 'plugins' | 'experimental' | 'about';
...
const ABOUT_CONTACT_EMAIL = 'egoai@example.com';
...
const Settings: React.FC<SettingsProps> = ({
  ...
  const renderAppearanceSettings = () => (
    <div className="space-y-8">
      <div>
        <h4 className="text-sm font-medium mb-3" style={{ color: 'var(--ego-text-primary)' }}>
          ...
          {(['light', 'dark', 'system'] as const).map((mode) => {
            ...
            return (
              <button
                ...
                style={{
                  borderColor: isSelected ? 'var(--ego-primary)' : 'var(--ego-border)',
                  backgroundColor: isSelected ? 'var(--ego-primary-muted)' : undefined,
                }}
              >
                ...
                <span className="text-xs font-medium" style={{ color: isSelected ? 'var(--ego-primary)' : 'var(--ego-text-primary)' }}>
                  {i18nService.t(mode)}
                </span>
              </button>
            );
        ...
        <h4 className="text-sm font-medium mb-3 mt-5" style={{ color: 'var(--ego-text-primary)' }}>
          ...
          const renderTile = (t: import('../theme').ThemeDefinition) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] font-medium truncate w-full text-center" style={{ color: isSelected ? 'var(--ego-primary)' : 'var(--ego-text-primary)' }}>
      ...
      case 'about':
        return (
          <div className="flex min-h-full flex-col items-center pt-6 pb-3">
            ...
            />
            <h3 className="text-lg font-semibold text-foreground">EgoAI</h3>
            ...
            <div className="mt-auto w-full pt-14 pb-2 flex flex-col items-center">
              ...
              <p className="mt-1 text-center text-xs text-secondary">
                Copyright &copy; {new Date().getFullYear()} EgoAI. All Rights Reserved.
              </p>
            </div>
          </div>
        );
