...
const AgentTaskRow: React.FC<AgentTaskRowProps> = ({
  ...
  const displayTitle = getIMSessionDisplayTitle(task.title, task.imPlatform).title;
  const imPlatformLogo = getIMSessionPlatformLogo(task.imPlatform);
  const imPlatformLabel = getIMSessionPlatformLabel(task.imPlatform);
  const imPlatformIconClassName = getIMSessionPlatformIconClassName(task.imPlatform);
  const editableTitle = displayTitle;
