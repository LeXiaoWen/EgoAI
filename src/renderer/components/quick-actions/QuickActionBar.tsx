      ...
      {actions.map((action) => {
        ...
        return (
          <button
            ...
            className={`group flex items-center gap-1.5 rounded-full border px-3.5 py-1.5 text-[length:var(--ego-text-sidebarCompact)] font-normal leading-5 transition-all duration-200 ease-out active:translate-y-0 active:scale-[0.97] ${
              isSelected
                ? 'border-[color-mix(in_srgb,var(--ego-primary)_50%,transparent)] bg-primary-muted text-primary'
