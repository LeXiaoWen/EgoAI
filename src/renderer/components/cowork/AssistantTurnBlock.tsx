...
const ContextCompactionDivider: React.FC<{ label: string; active?: boolean }> = ({
  ...
  >
    ...
    <div className="flex max-w-[min(100%,360px)] flex-col items-center gap-1.5 bg-background px-2">
      <div className="inline-flex max-w-full items-center gap-2 text-sm font-normal leading-[var(--ego-leading-promptLarge)] text-foreground/95">
...
/**
 * User-facing model source label. Users only need two buckets — the EgoAI
