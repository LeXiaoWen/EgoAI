...
const HOME_OVERLAY = [
  ...
  'color-mix(in srgb, var(--ego-background) 62%, transparent) 0%,',
  'color-mix(in srgb, var(--ego-background) 44%, transparent) 47%,',
  'color-mix(in srgb, var(--ego-background) 22%, transparent) 100%)',
  ', linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-background) 12%, transparent),',
  'color-mix(in srgb, var(--ego-background) 54%, transparent))',
].join(' ');

const CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-background) 20%, transparent),',
  'color-mix(in srgb, var(--ego-background) 36%, transparent))',
].join(' ');

const PRESENTED_HOME_OVERLAY = [
  'radial-gradient(ellipse at 50% 46%,',
  'color-mix(in srgb, var(--ego-skin-canvas) 52%, transparent) 0%,',
  'color-mix(in srgb, var(--ego-skin-canvas) 34%, transparent) 48%,',
  'color-mix(in srgb, var(--ego-skin-canvas) 18%, transparent) 100%)',
  ', linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-skin-canvas) 12%, transparent),',
  'color-mix(in srgb, var(--ego-skin-canvas) 82%, transparent))',
].join(' ');

const PRESENTED_CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-skin-canvas) 44%, transparent),',
  'color-mix(in srgb, var(--ego-skin-canvas) 62%, transparent))',
].join(' ');

const PRESENTED_DARK_CONVERSATION_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-skin-canvas) 30%, transparent),',
  'color-mix(in srgb, var(--ego-skin-canvas) 45%, transparent))',
].join(' ');

const PRESENTED_MANAGEMENT_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-skin-canvas) 32%, transparent),',
  'color-mix(in srgb, var(--ego-skin-canvas) 46%, transparent))',
].join(' ');

const PRESENTED_DARK_MANAGEMENT_OVERLAY = [
  'linear-gradient(to bottom,',
  'color-mix(in srgb, var(--ego-skin-canvas) 18%, transparent),',
  'color-mix(in srgb, var(--ego-skin-canvas) 30%, transparent))',
].join(' ');
    ...
    >
      <img
        ...
        style={hasPresentation ? {
          objectPosition: 'var(--ego-skin-focus-x) var(--ego-skin-focus-y)',
        } : undefined}
