...
export const THEME_APPEARANCE_STORAGE_KEY = 'ego-theme-appearance';
...
export interface ThemeManagerOptions {
  /** localStorage key for persistence. Default: 'ego-theme' */
  storageKey?: string;
...
export class ThemeManager {
  ...
  constructor(themes: ThemeDefinition[], options: ThemeManagerOptions = {}) {
    ...
    this.opts = {
      storageKey: options.storageKey ?? 'ego-theme',
