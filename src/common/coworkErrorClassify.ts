...
const EGOAI_QUOTA_EXHAUSTED_PATTERN =
...
const ERROR_RULES: Array<[RegExp, string]> = [
  ...
  // EgoAI plan/free quota. Must precede generic 402/billing handling.
  [EGOAI_QUOTA_EXHAUSTED_PATTERN, CoworkErrorI18nKey.QuotaExhausted],
...
export function isEgoAIQuotaExhaustedError(error: string): boolean {
  return EGOAI_QUOTA_EXHAUSTED_PATTERN.test(error);
}
