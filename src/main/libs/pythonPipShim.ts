...
// Canonical content of the EgoAI-generated pip shim and wrapper files for
...
// true for every historical EgoAI shim, never for a real pip package
...
/**
 * Converge EgoAI-owned pip shim/wrapper files to the current templates.
 *
