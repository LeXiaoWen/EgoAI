...
export const EGOAI_CLIENT_CAPABILITIES_HEADER = 'X-LobsterAI-Client-Capabilities';
export const EGOAI_CLIENT_VERSION_HEADER = 'X-LobsterAI-Client-Version';
...
export const EGOAI_CLIENT_CAPABILITIES = [
