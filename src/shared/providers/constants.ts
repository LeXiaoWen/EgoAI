...
// ─── Provider Name ──────────────────────────────────────────────────────
// providerName identifies the EgoAI internal provider (config key).
...
export const OpenClawProviderId = {
  ...
  OpenRouter: 'openrouter',
  Copilot: 'github-copilot',
  EgoaiCopilot: 'lobsterai-copilot',
  Ollama: 'ollama',
  LmStudio: 'lm-studio',
  Ego: 'lobster',
} as const;
...
const PROVIDER_DEFINITIONS = [
  ...
  // ── Global ──
  {
    ...
    openClawProviderId: OpenClawProviderId.EgoaiCopilot,
...
class ProviderRegistryImpl {
  ...
  getOpenClawProviderId(providerName: string): string {
    return this.idIndex.get(providerName)?.openClawProviderId ?? providerName ?? OpenClawProviderId.Ego;
  }
